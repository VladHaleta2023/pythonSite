...
while(True):
    ...
    if s == 1:
        ...
        inputStr = str(input())
        print("Functions in degrees? (y/n)")
        inDegrees = input()

        if str(inDegrees).lower() == 'y':
            inDegrees = True
        else:
            inDegrees = False
        ...
        calcRes = ResultBS(inputStr, inDegrees, decPlaces)
        if str(calcRes.getResult()) != "":
            print("Your result is: ", str(calcRes.getResult()))
        else:
            print("Error input")
    elif s == 2:
        ...
        if value1 > value2:
            print("The biggest number is: " + str(value1))
        elif value1 < value2:
            print("The biggest number is: " + str(value2))
        else:
